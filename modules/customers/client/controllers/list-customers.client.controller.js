  ...
  function CustomersListController(CustomersService, $compile, $scope, $location) {
    ...
    */
    vm.getItemData = function() {
      ...
      //If a customer is selected there is no data we need to obtain
      if (selectedPath <= 1)
        return;
      
      //Finds ids of shipment,order,customer from the hiearchy    
      ...
      //Loops through array of customers to find selected item id
        ...
        if(orderID != undefined){
          ...
          //Fill in the components of the right sidebar based on item selected
          closeAllInfoWindows();
          customerInfo();
          shippingDetails();
          packageDetails();
